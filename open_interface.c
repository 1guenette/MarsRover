 ...
 *	@breif This is the open interface file for the robot functions. Provided to us.
 *
 * 	@author Noah Bergman, Eric Middleton, and dmlarson
...
int getDegrees(oi_t *self){
	...
	double deg = (distRight - distLeft)/171.0;//change 178.5 to improve accuracy of turning if needed
	deg = (deg*180)/M_PI;
